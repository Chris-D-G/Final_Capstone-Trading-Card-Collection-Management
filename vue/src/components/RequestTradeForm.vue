<template>
<div>
    <h2 class="text-dark fs-1 text-center fw-bold title mt-4 p-3 w-35 mx-auto bg-white rounded-5 border border-1 border-white shadow"
  ...
  <div class="d-flex justify-content-center">
    ...
    >
      ...
      <p class="fst-italic fw-light fs-10">*Hit submit to send user an autogenerated message requesting this trade!</p>
    </div>
  </div>
  </div>
</template>
